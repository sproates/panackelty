...
An initial Panackelty-hosted runner now checks nineteen existing functional
fixtures alongside the Python harness; full corpus and oracle migration remain.
