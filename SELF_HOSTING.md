...
An initial Panackelty-hosted runner now checks twenty-one success fixtures, all
...
through the new runner; remaining CLI coverage and oracle migration remain.
