...
`make harness PYTHON=false` also runs on both supported CI platforms. Shell groups
...
The remaining 21 Python methods protect only the transitional implementation.
