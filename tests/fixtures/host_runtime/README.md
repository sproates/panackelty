...
were retired. The other six remain active as independent Python compiler/VM
oracles for the next milestone. No Python test was retired because of a warning
...
| Original method | Replacement or retained oracle |
|---|---|
...
| `tests/unit/vm/test_host_capabilities.py::test_oracle_shared_conformance` | Retained Python differential/byte-identity oracle |
...
| `tests/unit/vm/test_host_types.py::test_oracle_matches_shared_host_type_conformance` | Retained Python differential/byte-identity oracle |
...
| `tests/unit/vm/test_native_execution.py::test_native_vm_matches_program_outputs` | Retained Python differential/byte-identity oracle |
| `tests/unit/vm/test_native_execution.py::test_rational_arithmetic_matches_fraction_oracle` | Retained Python differential/byte-identity oracle |
| `tests/unit/vm/test_native_execution.py::test_native_vm_runs_the_self_hosted_compiler` | Retained Python differential/byte-identity oracle |
...
| `tests/unit/compiler/test_stdlib.py::test_complete_library_is_byte_identical_at_bootstrap_and_stage_one` | Retained Python differential/byte-identity oracle |
